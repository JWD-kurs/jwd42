...
import jwd.wafepa.suppport.ActivityDtoToActivity;
import jwd.wafepa.suppport.ActivityToActivityDto;
...
public class ApiActivityController {
	...
	public ResponseEntity<List<ActivityDTO>> getActivities(@RequestParam String name){
